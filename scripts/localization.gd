...
var texts := {
	"zh": {
		...
		"INV_TAB_CHARACTER": "角色",
		"INV_TAB_BAG": "背包",
		"INV_TAB_SKILLS": "技能",
		"INV_TAB_MAP": "地圖",
		"INV_TAB_SYSTEM": "系統",
		"INV_CAT_ALL": "全部",
		"INV_CAT_CONSUMABLE": "消耗品",
		"INV_CAT_MATERIAL": "材料",
		"INV_CAT_SKILL": "技能",
		"INV_CAT_IMPORTANT": "重要",
		"INV_EQUIPPED_SKILLS": "裝備技能",
		"INV_SKILL_SLOT": "技能 %d",
		"INV_SKILL_SLOT_EMPTY": "技能 %d\n未裝備",
		"INV_SKILL_SLOT_EQUIPPED": "技能 %d\n%s",
		"INV_HINT": "{inventory} / Esc：關閉\n點選技能：裝備",
		"INV_PROFILE_TEXT": "名稱：海騎士\n等級：1\n生命：%s / %s\n金幣：%d\n裝備技能欄：%d\n水下風格：八向游動\n衝刺與壁面爆發",
		"INV_SELECT_ITEM": "選擇一個項目",
		"INV_DEFAULT_DESC": "可查看背包物品、技能、地圖與角色資訊。",
		"INV_CHARACTER_DATA": "角色資料",
		"INV_FUTURE_STATS": "未來能力值",
		"INV_FUTURE_STATS_DESC": "力量、防禦、魔力與水下機動性都可以在這裡擴充。",
		"INV_CONTROLS": "操作",
		"INV_CONTROLS_DESC": "Z：跳躍。X：攻擊。C：衝刺。F：水槍。I：背包。M：地圖。P：聲音。",
		"INV_SKILL_TREE": "技能盤",
		"INV_SKILL_CORE_LOCKED": "核心\n未解鎖",
		"INV_SKILL_WATER_DASH": "水下衝刺",
		"INV_SKILL_WATER_DASH_DESC": "在水下快速往按鍵方向衝刺。",
		"INV_SKILL_WALL_BURST": "壁面爆發",
		"INV_SKILL_WALL_BURST_DESC": "碰到牆壁時可往按鍵方向爆發移動。",
		"INV_SKILL_WATER_SHOT": "水槍",
		"INV_SKILL_WATER_SHOT_DESC": "按 F 發射遠程水槍攻擊。",
		"INV_SKILL_QUICK_MAP": "快速地圖",
		"INV_SKILL_QUICK_MAP_DESC": "按 M 切換小地圖、大地圖與關閉。",
		"SHOP_TITLE": "%s 的商店",
	...
	"en": {
		...
		"INV_TAB_CHARACTER": "Character",
		"INV_TAB_BAG": "Bag",
		"INV_TAB_SKILLS": "Skills",
		"INV_TAB_MAP": "Map",
		"INV_TAB_SYSTEM": "System",
		"INV_CAT_ALL": "All",
		"INV_CAT_CONSUMABLE": "Consumables",
		"INV_CAT_MATERIAL": "Materials",
		"INV_CAT_SKILL": "Skills",
		"INV_CAT_IMPORTANT": "Important",
		"INV_EQUIPPED_SKILLS": "Equipped Skills",
		"INV_SKILL_SLOT": "Skill %d",
		"INV_SKILL_SLOT_EMPTY": "Skill %d\nEmpty",
		"INV_SKILL_SLOT_EQUIPPED": "Skill %d\n%s",
		"INV_HINT": "{inventory} / Esc: Close\nClick a skill: Equip",
		"INV_PROFILE_TEXT": "Name: Sea Knight\nLevel: 1\nHP: %s / %s\nCoins: %d\nSkill Slots: %d\nUnderwater Style:\n8-way swim and wall burst",
		"INV_SELECT_ITEM": "Select an item",
		"INV_DEFAULT_DESC": "View bag items, skills, map, and character info.",
		"INV_CHARACTER_DATA": "Character Data",
		"INV_FUTURE_STATS": "Future Stats",
		"INV_FUTURE_STATS_DESC": "Strength, defense, magic, and underwater mobility can be expanded here later.",
		"INV_CONTROLS": "Controls",
		"INV_CONTROLS_DESC": "Z: Jump. X: Attack. C: Dash. F: Water Shot. I: Bag. M: Map. P: Sound.",
		"INV_SKILL_TREE": "Skill Tree",
		"INV_SKILL_CORE_LOCKED": "Core\nLocked",
		"INV_SKILL_WATER_DASH": "Underwater Dash",
		"INV_SKILL_WATER_DASH_DESC": "Dash quickly underwater toward the held direction.",
		"INV_SKILL_WALL_BURST": "Wall Burst",
		"INV_SKILL_WALL_BURST_DESC": "Burst away in the held direction while touching a wall.",
		"INV_SKILL_WATER_SHOT": "Water Shot",
		"INV_SKILL_WATER_SHOT_DESC": "Press F to fire a ranged water shot.",
		"INV_SKILL_QUICK_MAP": "Quick Map",
		"INV_SKILL_QUICK_MAP_DESC": "Press M to switch between mini map, full map, and closed.",
		"SHOP_TITLE": "%s's Shop",
