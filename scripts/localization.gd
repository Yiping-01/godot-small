...
var raw_texts := {
	...
	"Back to right route": "Back to right route",
	"Returning": "Returning",
	"返回教學地圖": "Returning to tutorial map",
	"前往上方房間（之後製作）": "Go to upper room (coming later)",
	"前往右側房間（之後製作）": "Go to right room (coming later)",
	"前往右側房間": "Go to right room",
	"回去": "Back",
	"進入下一個區域中...": "Entering the next area...",
	"移動到下個地圖": "Moving to the next map",
	"移動到下個地圖中...": "Moving to the next map...",
	"移動到下一張地圖": "Moving to the next map",
	"移動到下一張地圖...": "Moving to the next map...",
	"移動到下一張地圖中...": "Moving to the next map...",
	...
	"嘗試通過這危險的道路吧，若空中跳躍距離不夠，可在空中按下 C 進行短距離衝刺": "Try to cross this dangerous path. If your jump is not far enough, press {dash} in the air to dash a short distance.",
	...
	"地區名": "Area Name",
	"位置名": "Location Name",
	"Left Route": "Left Route",
	"Right Route": "Right Route",
	"Upper Route": "Upper Route",
	"Sealed room": "Sealed Room",
	"Prototype room": "Prototype Room",
	"Prototype route": "Prototype Route",
	"Forgotten Test Path": "Forgotten Test Path",
	"旅人": "Traveler",
	"商人": "Merchant",
